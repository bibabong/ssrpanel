...
function install_ssrpanel(){
	...
	wget -N -P /usr/local/php/etc/ https://raw.githubusercontent.com/bibabong/ssrpanel/master/php.ini
	wget -N -P /usr/local/nginx/conf/ https://raw.githubusercontent.com/bibabong/ssrpanel/master/nginx.conf
...
function install_ssr(){
	...
	if [ "$libAddr" == "$GIT" ];then
		libAddr='https://raw.githubusercontent.com/bibabong/ssrpanel/master/libsodium-1.0.13.tar.gz'
	else
    ...
    cd /root
	wget https://raw.githubusercontent.com/bibabong/ssrpanel/master/shadowsocksr.zip
	unzip shadowsocksr.zip
	cd shadowsocksr
	./initcfg.sh
	chmod 777 *
	wget -N -P /root/shadowsocksr/ https://raw.githubusercontent.com/bibabong/ssrpanel/master/user-config.json
	wget -N -P /root/shadowsocksr/ https://raw.githubusercontent.com/bibabong/ssrpanel/master/userapiconfig.py
	wget -N -P /root/shadowsocksr/ https://raw.githubusercontent.com/bibabong/ssrpanel/master/usermysql.json
...
function install_BBR(){
     wget --no-check-certificate https://raw.githubusercontent.com/bibabong/ssrpanel/master/bbr.sh&&chmod +x bbr.sh&&./bbr.sh
}
function install_RS(){
     wget -N --no-check-certificate https://raw.githubusercontent.com/bibabong/ssrpanel/master/serverspeeder.sh && bash serverspeeder.sh
}
